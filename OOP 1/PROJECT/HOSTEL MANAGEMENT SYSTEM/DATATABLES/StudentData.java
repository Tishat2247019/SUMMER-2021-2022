...
public class StudentData extends JFrame implements ActionListener {
	...
	public void Read() {
		...
		try {
			File file = new File("F:\\VSCODE\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\DataStudent.txt");
	...
	public void write() {
		try {
			File file = new File(
					"F:\\VSCODE\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\DataStudent.txt");
			if (!file.exists()) {
				file.createNewFile();
			}
